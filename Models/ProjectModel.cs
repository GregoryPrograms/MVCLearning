...
{  
  public projects()
    {
        //Will add code here to pull projects from github. Will add a way to search through github for projects flagged as viable projects, then construct the class object from information about each project - which will then be used to translate to CSS.
    }
}
